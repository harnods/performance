...
// goal's OWNER (branch / organization / job position / job level / employment
// status), mirroring talenta-review's DrawerAllFilters scopes. Applied filters
// are keyed by scope → selected values; empty = no filter.
// ─────────────────────────────────────────────────────────────────────────────
