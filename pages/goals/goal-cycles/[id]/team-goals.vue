            ...
            <MpTable :is-hoverable="false" :class="fixedTable">
              ...
              <MpTableHead>
                ...
                <MpTableRow v-else>
                  ...
                  <MpTableCell as="th" :class="[colDivider, colTeam]"><span :class="headerLabel">Team <MpIcon name="sort-default" size="sm" /></span></MpTableCell>
              ...
              <MpTableBody>
                <MpTableRow v-for="(row, ri) in dept.rows" :key="row.id">
                  ...
                  <MpTableCell v-if="ri === 0" as="td" :rowspan="dept.rows.length" :class="[tightCell, colDivider, colTeam]">
                    <div :class="teamCell">
